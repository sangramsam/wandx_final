...
@Component({
  selector: 'app-exchange-tradehistory-sidepane-wan',
  templateUrl: './exchange-tradehistory-sidepane-wan.component.html',
  styleUrls: ['./exchange-tradehistory-sidepane-wan.component.css']
})
export class ExchangeTradehistorySidepaneWanComponent implements OnInit {
  ...
  getOrderTransactions() {
   ...
   // console.log(this.selectedPlatformToken.id);
    ...
    this.http.get(Constants.ServiceURLWAN + 'ordertransaction/all/' + this.selectedPlatformToken.id, requestOptions).subscribe(
      data => {
