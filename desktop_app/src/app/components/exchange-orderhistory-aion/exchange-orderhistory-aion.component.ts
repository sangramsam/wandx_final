...
@Component({
  selector: 'app-exchange-orderhistory-aion',
  templateUrl: './exchange-orderhistory-aion.component.html',
  styleUrls: ['./exchange-orderhistory-aion.component.css']
})
export class ExchangeOrderhistoryAionComponent implements OnInit {
