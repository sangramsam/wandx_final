...
@Component({
  selector: 'app-exchange-tradehistory-sidepane-aion',
  templateUrl: './exchange-tradehistory-sidepane-aion.component.html',
  styleUrls: ['./exchange-tradehistory-sidepane-aion.component.css']
})
export class ExchangeTradehistorySidepaneAionComponent implements OnInit {
  ...
  getOrderTransactions() {
   ...
   // console.log(this.selectedPlatformToken.id);
    
    this.http.get(Constants.ServiceURLAION + 'ordertransaction/all/' + this.selectedPlatformToken.id, requestOptions).subscribe(
      data => {
