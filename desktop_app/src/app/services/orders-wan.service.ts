...
import { PortfolioWanService } from './portfolio-wan.service';
@Injectable()
export class OrdersWanService {
  ...
  constructor(private http: Http, private portfolioService: PortfolioWanService,
